...
import ex0.algo.ElevatorAlgo_Solution;
import ex0.algo.ElevatorAlgo_Solution;
...
public class Ex0_main {
    public static Long ID0=208278556L, ID1 = 318916335L, ID2 = null;
    ...
    public static void main(String[] ar) {
        ...
        ElevatorAlgo ex0_alg = new ElevatorAlgo_Solution(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
